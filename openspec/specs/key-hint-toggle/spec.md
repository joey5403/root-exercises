# Key Hint Toggle Specification

## Purpose

This specification defines the key hint visibility toggle feature, allowing users to control whether key hints are displayed below radical images.
